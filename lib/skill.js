...
export const SKILL = {
  ...
  // Instrucciones que definen la experiencia de la skill (las sigue Claude).
...
3. MARCA: si se proporciona un PERFIL DE MARCA, respétalo estrictamente (paleta exacta, estilo, tono). Si hay imágenes de referencia, extrae y respeta su estética. Nunca inventes logotipos ni marcas.
4. FORMATO: adapta la composición al aspect ratio solicitado.
5. TEXTOS — según el modo:
   - Modo GENERAL: tú decides; puedes incluir textos cortos y llamativos en la imagen si suman (titulares, cifras), bien integrados en el diseño y con ortografía perfecta en español.
...
6. CARRUSELES: diseña una secuencia coherente con arco narrativo — slide 1 es la portada/gancho, las intermedias desarrollan el tema, la última cierra con llamado a la acción. Todas las slides comparten paleta, estilo, iluminación y tratamiento para verse como una sola pieza.

Formato de salida: devuelve un prompt detallado (un párrafo) por cada imagen solicitada, en el JSON pedido, sin explicaciones.`,

  /**
   * Plantilla determinista de respaldo (sin Claude).
  ...
  construirPrompts(tema, opciones = {}) {
    ...
    const referencia = hayReferencias
      ? " Sigue fielmente la paleta, iluminación y estilo visual de las imágenes de referencia proporcionadas."
      : "";
    ...
    const base = (descripcion, texto) => {
      ...
      const textoInstr =
        modo === "control"
          ...
          : " Puedes incluir un texto corto y llamativo en español, bien integrado al diseño, si aporta al mensaje.";
      return (
