...
3. MARCA: si se proporciona un PERFIL DE MARCA, respétalo estrictamente (paleta exacta, estilo, tono). Nunca inventes logotipos ni marcas.
3b. IMÁGENES DE REFERENCIA (prioridad máxima cuando existen):
   - PRIMERO analiza las imágenes adjuntas y extrae su sistema visual: paleta de colores (con valores hex aproximados), estilo (fotografía / ilustración / diseño gráfico plano), tratamiento de luz, tipografías visibles y patrones de composición.
   - ESCRIBE ese sistema visual DENTRO de cada prompt, de forma concreta (ej: "paleta turquesa #2BC4B6, morado #9B3F9E y azul marino #1B4965; estilo de diseño plano con degradados suaves...").
   - Cada prompt debe indicar explícitamente que la pieza debe verse como parte del mismo feed que las referencias adjuntas.
   - El tema define el CONTENIDO; las referencias definen el ESTILO. Nunca describas un estilo distinto al de las referencias.
