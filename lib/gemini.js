...
async function generateOne({ prompt, referenceImages, aspectRatio }) {
  ...
  const instruction = referenceImages.length
    ? `REGLA OBLIGATORIA E INNEGOCIABLE: las ${referenceImages.length} imágenes adjuntas son la referencia real de marca. ` +
